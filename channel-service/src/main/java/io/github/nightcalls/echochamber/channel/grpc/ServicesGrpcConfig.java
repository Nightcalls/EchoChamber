...
import io.github.nightcalls.echochamber.user.api.grpc.UserApiServiceWrapper;
...
public class ServicesGrpcConfig {
    ...
    public UserApiService getUserApiService() {
        ManagedChannel grpcUserApiToChannel = ManagedChannelBuilder
                .forTarget(String.valueOf(grpcUserApiUrl))
                .usePlaintext()
                .build();
